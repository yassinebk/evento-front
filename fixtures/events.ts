...
export const EventXs: EventX[] = [
    ...
    },
    {
        ...
        description: "Get ready to laugh with some of the best comedians in the city!",
    ...
    },
    {
        ...
        tags: ["art", "exhibition"],
        description: "Experience the beauty and creativity of some of the world's most talented artists!",
    ...
    },
    {
        ...
        tags: ["food", "festival "], description: "Satisfy your taste buds with a variety of delicious foods from around the world!",
    ...
    },
    {
        ...
        tags: ["film", "festival"],
        description: "Experience the magic of cinema with some of the best films from around the world!",
    ...
    },
    {
        ...
        description: "Learn about the latest trends and innovations in the world of technology!",
    ...
    },
    {
        ...
        tags: ["fashion", "show"],
        description: "Experience the glamour and style of the fashion world with some of the top designers in the industry!",
